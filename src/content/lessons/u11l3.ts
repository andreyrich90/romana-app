...
export const u11l3: Lesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      note: {
        ru: 'Женские имена и слова на -a получают -ei: Maria → Mariei «марией», Ana → Anei «аней», mama → mamei «мамей». geantă ≈ «джантэ».',
        ua: 'Жіночі імена й слова на -a отримують -ei: Maria → Mariei «марієй», Ana → Anei «аней», mama → mamei «мамей». geantă ≈ «джанте».',
      },
    },
    {
      kind: 'intro',
    ...
    },
    {
      ...
      rows: [
        ...
        { ro: 'geanta Anei', tr: { ru: 'сумка Анны · «джанта аней»', ua: 'сумка Анни · «джанта аней»' } },
