...
export const u2l3: Lesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      rows: [
        { ro: 'eu am', tr: { ru: 'у меня есть · «ам»', ua: 'у мене є · «ам»' } },
        { ro: 'tu ai', tr: { ru: 'у тебя есть · «ай»', ua: 'у тебе є · «ай»' } },
        { ro: 'el, ea are', tr: { ru: 'у него, у неё · «аре»', ua: 'у нього, у неї · «аре»' } },
        { ro: 'noi avem', tr: { ru: 'у нас есть · «авем»', ua: 'у нас є · «авем»' } },
        { ro: 'voi aveți', tr: { ru: 'у вас есть · «авець»', ua: 'у вас є · «авець»' } },
        { ro: 'ei, ele au', tr: { ru: 'у них есть · «ау»', ua: 'у них є · «ау»' } },
      ],
    },
    {
      kind: 'match',
