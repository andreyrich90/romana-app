...
export const u1l3: Lesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      answers: ['El este român', 'Este român', 'El e român', 'E român'],
      shown: 'El este român.',
    },
    {
      kind: 'type',
      q: { ru: 'Я немного говорю по-румынски.', ua: 'Я трохи розмовляю румунською.' },
      answers: ['Vorbesc puțin română', 'Eu vorbesc puțin română', 'Vorbesc puțin românește', 'Eu vorbesc puțin românește'],
