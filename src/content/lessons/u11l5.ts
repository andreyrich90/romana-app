  ...
  exercises: [
    {
      ...
      rows: [
        { ro: 'geanta mamei', tr: { ru: 'сумка мамы · «джанта мамей»', ua: 'сумка мами · «джанта мамей»' } },
        { ro: 'Îi dau mamei.', tr: { ru: 'Я даю маме. · «ый дау мамей»', ua: 'Я даю мамі. · «ий дау мамей»' } },
        { ro: 'o geacă neagră', tr: { ru: 'чёрная куртка · «о джакэ нягрэ»', ua: 'чорна куртка · «о джаке нягре»' } },
      ],
    },
    {
      kind: 'pickRo',
