...
export const u1l2: Lesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      rows: [
        { ro: 'eu sunt', tr: { ru: 'я · «еу сунт»', ua: 'я · «єу сунт»' } },
        { ro: 'tu ești', tr: { ru: 'ты · «ту ешть»', ua: 'ти · «ту ешть»' } },
        { ro: 'el, ea este', tr: { ru: 'он, она · «ел, я есте»', ua: 'він, вона · «єл, я єсте»' } },
        { ro: 'noi suntem', tr: { ru: 'мы · «ной сунтем»', ua: 'ми · «ной сунтем»' } },
        { ro: 'voi sunteți', tr: { ru: 'вы · «вой сунтець»', ua: 'ви · «вой сунтець»' } },
        { ro: 'ei, ele sunt', tr: { ru: 'они · «ей, еле сунт»', ua: 'вони · «єй, єле сунт»' } },
      ],
    },
    {
      kind: 'intro',
