...
export const u3l3: Lesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      rows: [
        { ro: 'eu vreau', tr: { ru: 'я хочу', ua: 'я хочу' } },
        { ro: 'tu vrei', tr: { ru: 'ты хочешь', ua: 'ти хочеш' } },
        { ro: 'el, ea vrea', tr: { ru: 'он, она хочет', ua: 'він, вона хоче' } },
        { ro: 'noi vrem', tr: { ru: 'мы хотим', ua: 'ми хочемо' } },
        { ro: 'voi vreți', tr: { ru: 'вы хотите', ua: 'ви хочете' } },
        { ro: 'ei, ele vor', tr: { ru: 'они хотят', ua: 'вони хочуть' } },
      ],
    },
    {
      kind: 'pickRo',
