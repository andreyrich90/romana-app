  ...
  exercises: [
    {
      ...
      note: {
        ...
        ua: 'trebuie ≈ «требуе» — «треба». Саме слово не змінюється, кому треба — видно з другого дієслова.',
      },
    },
    {
      kind: 'intro',
    ...
    },
    {
      ...
      rows: [
        { ro: 'Trebuie să plec.', tr: { ru: 'Мне пора. · «требуе сэ плек»', ua: 'Мені час. · «требуе се плек»' } },
        { ro: 'Trebuie să pleci.', tr: { ru: 'Тебе пора. · «требуе сэ плечь»', ua: 'Тобі час. · «требуе се плечь»' } },
        { ro: 'Trebuie să plece.', tr: { ru: 'Ему (ей, им) пора. · «требуе сэ плече»', ua: 'Йому (їй, їм) час. · «требуе се плече»' } },
        { ro: 'Trebuie să plecăm.', tr: { ru: 'Нам пора. · «требуе сэ плекэм»', ua: 'Нам час. · «требуе се плекем»' } },
      ],
    },
    {
      kind: 'pickRo',
