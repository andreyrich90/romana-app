...
export type CardTheme = 'work' | 'docs' | 'health' | 'shop' | 'transport' | 'home' | 'bank' | 'food' | 'social' | 'travel' | 'post' | 'school' | 'leisure' | 'nature';
...
export const CARDS: LearnCard[] = [
  ...
  },
  {
    ...
    theme: 'nature',
    ro: 'Ce cald e!',
    tr: bi('жарко, холодно, градусы', 'спекотно, холодно, градуси'),
    meaning: bi(
      'Как говорить о температуре. Важная разница: «e cald» — на улице жарко, «mi-e cald» — мне жарко.',
      'Як говорити про температуру. Важлива різниця: «e cald» — надворі спекотно, «mi-e cald» — мені жарко.',
    ),
    examples: [
      w('Ce cald e azi!', 'Как сегодня жарко!', 'Як сьогодні спекотно!'),
      w('Sunt treizeci de grade la umbră.', 'Тридцать градусов в тени.', 'Тридцять градусів у затінку.'),
      w('Noaptea sunt minus zece grade.', 'Ночью минус десять.', 'Уночі мінус десять.'),
      w('Mi-e frig, închide fereastra.', 'Мне холодно, закрой окно.', 'Мені холодно, зачини вікно.'),
    ],
    expressions: [
      w('e cald', 'тепло, жарко (на улице)', 'тепло, спекотно (надворі)'),
      w('e frig', 'холодно', 'холодно'),
      w('e răcoare', 'прохладно', 'прохолодно'),
      w('grade', 'градусы', 'градуси'),
    ],
    remember: bi(
      'Погода — **e cald / e frig** (безлично). Ощущения — **mi-e cald / mi-e frig** (мне). С 20 градусов — с **de**: douăzeci **de** grade.',
      'Погода — **e cald / e frig** (безособово). Відчуття — **mi-e cald / mi-e frig** (мені). З 20 градусів — з **de**: douăzeci **de** grade.',
    ),
    practice: [
      task('Как жарко!', 'Як спекотно!', ['Ce cald e', 'Ce cald este', 'E foarte cald']),
      task('Мне холодно.', 'Мені холодно.', ['Mi-e frig', 'Mie mi-e frig', 'Îmi este frig']),
      task('Тридцать градусов.', 'Тридцять градусів.', ['Treizeci de grade', 'Sunt treizeci de grade']),
    ],
  },
  {
    id: 'ploaie',
    ...
    tr: bi('дождь', 'дощ'),
    meaning: bi(
      'Дождь. «Идёт дождь» — одно слово: plouă. А ливень по-румынски «льёт как из ведра» — plouă cu găleata.',
      'Дощ. «Іде дощ» — одне слово: plouă. А злива румунською «ллє як із відра» — plouă cu găleata.',
    ),
    examples: [
      w('Plouă de dimineață.', 'Дождь идёт с утра.', 'Дощ іде з ранку.'),
      w('Afară plouă cu găleata.', 'На улице льёт как из ведра.', 'Надворі ллє як із відра.'),
      w('Ia-ți umbrela, o să plouă.', 'Возьми зонтик, будет дождь.', 'Візьми парасольку, буде дощ.'),
      w('A stat ploaia, putem ieși.', 'Дождь закончился, можно выходить.', 'Дощ скінчився, можна виходити.'),
    ],
    expressions: [
      w('plouă', 'идёт дождь', 'іде дощ'),
      w('umbrelă', 'зонт', 'парасолька'),
      w('ud', 'мокрый', 'мокрий'),
      w('nor', 'облако, туча', 'хмара'),
    ],
    remember: bi(
      'Ploaie — **женский род**, мн. **ploi**. «Будет дождь» — **o să plouă** или **va ploua**. «Промок до нитки» — **sunt ud leoarcă**.',
      'Ploaie — **жіночий рід**, мн. **ploi**. «Буде дощ» — **o să plouă** або **va ploua**. «Промок до нитки» — **sunt ud leoarcă**.',
    ),
    practice: [
      task('Идёт дождь.', 'Іде дощ.', ['Plouă']),
      task('Возьми зонтик.', 'Візьми парасольку.', ['Ia-ți umbrela', 'Ia umbrela', 'Ia-ți o umbrelă']),
      task('Будет дождь.', 'Буде дощ.', ['O să plouă', 'Va ploua']),
    ],
  },
  {
    id: 'zapada',
    ...
    tr: bi('снег', 'сніг'),
    meaning: bi(
      'Снег. «Идёт снег» — ninge. Зимой на дорогах опасен polei — гололёд, а в горах бывает viscol — метель.',
      'Сніг. «Іде сніг» — ninge. Узимку на дорогах небезпечна polei — ожеледиця, а в горах буває viscol — хуртовина.',
    ),
    examples: [
      w('Ninge de ieri.', 'Снег идёт со вчерашнего дня.', 'Сніг іде від учора.'),
      w('Copiii fac un om de zăpadă.', 'Дети лепят снеговика.', 'Діти ліплять сніговика.'),
      w('Atenție, e polei pe drum!', 'Осторожно, на дороге гололёд!', 'Обережно, на дорозі ожеледиця!'),
      w('A căzut multă zăpadă.', 'Выпало много снега.', 'Випало багато снігу.'),
    ],
    expressions: [
      w('ninge', 'идёт снег', 'іде сніг'),
      w('om de zăpadă', 'снеговик', 'сніговик'),
      w('polei', 'гололёд', 'ожеледиця'),
      w('viscol', 'метель', 'хуртовина'),
    ],
    remember: bi(
      'Zăpadă — **женский род**, во мн. почти не бывает. Снег и дождь — безличные глаголы: **ninge**, **plouă**, без «оно».',
      'Zăpadă — **жіночий рід**, у мн. майже не буває. Сніг і дощ — безособові дієслова: **ninge**, **plouă**, без «воно».',
    ),
    practice: [
      task('Идёт снег.', 'Іде сніг.', ['Ninge']),
      task('Снеговик.', 'Сніговик.', ['Om de zăpadă', 'Un om de zăpadă']),
      task('Гололёд.', 'Ожеледиця.', ['Polei', 'Poleiul', 'E polei']),
    ],
  },
  {
    id: 'soare',
    ...
    tr: bi('солнце', 'сонце'),
    meaning: bi(
      'Солнце. «Солнечно» — e soare. Летом в Румынии бывает очень жарко, поэтому пригодятся слова тень, крем и шляпа.',
      'Сонце. «Сонячно» — e soare. Улітку в Румунії буває дуже спекотно, тому знадобляться слова затінок, крем і капелюх.',
    ),
    examples: [
      w('Azi e soare.', 'Сегодня солнечно.', 'Сьогодні сонячно.'),
      w('Arde soarele, stai la umbră.', 'Солнце печёт, посиди в тени.', 'Сонце пече, посидь у затінку.'),
      w('Pune-ți cremă de protecție.', 'Намажься солнцезащитным кремом.', 'Намастися сонцезахисним кремом.'),
      w('Răsăritul e la șase.', 'Рассвет в шесть.', 'Світанок о шостій.'),
    ],
    expressions: [
      w('umbră', 'тень', 'затінок, тінь'),
      w('cremă de protecție', 'солнцезащитный крем', 'сонцезахисний крем'),
      w('răsărit', 'рассвет, восход', 'світанок, схід сонця'),
      w('apus', 'закат', 'захід сонця'),
    ],
    remember: bi(
      'Soare — **мужской род**: soarele. «Солнечно» — не прилагательное, а **e soare** («есть солнце»).',
      'Soare — **чоловічий рід**: soarele. «Сонячно» — не прикметник, а **e soare** («є сонце»).',
    ),
    practice: [
      task('Сегодня солнечно.', 'Сьогодні сонячно.', ['Azi e soare', 'Astăzi e soare', 'Azi este soare', 'E soare azi']),
      task('В тени.', 'У затінку.', ['La umbră']),
      task('Закат.', 'Захід сонця.', ['Apus', 'Apusul', 'Apusul soarelui']),
    ],
  },
  {
    id: 'vant',
    ...
    tr: bi('ветер', 'вітер'),
    meaning: bi(
      'Ветер. По-румынски ветер «бьёт»: bate vântul. Рядом — гроза, молния, гром.',
      'Вітер. Румунською вітер «б’є»: bate vântul. Поруч — гроза, блискавка, грім.',
    ),
    examples: [
      w('Bate vântul tare.', 'Дует сильный ветер.', 'Дме сильний вітер.'),
      w('Vine o furtună.', 'Надвигается буря.', 'Насувається буря.'),
      w('Am auzit un tunet.', 'Я слышал гром.', 'Я чув грім.'),
      w('Închide geamurile, e furtună!', 'Закрой окна, гроза!', 'Зачини вікна, гроза!'),
    ],
    expressions: [
      w('bate vântul', 'дует ветер', 'дме вітер'),
      w('fulger', 'молния', 'блискавка'),
      w('tunet', 'гром', 'грім'),
      w('furtună', 'буря, гроза', 'буря, гроза'),
    ],
    remember: bi(
      'Vânt — **средний род**: vântul, vânturi. Окно в разговоре — часто **geam** (стекло), официально — **fereastră**.',
      'Vânt — **середній рід**: vântul, vânturi. Вікно в розмові — часто **geam** (скло), офіційно — **fereastră**.',
    ),
    practice: [
      task('Дует ветер.', 'Дме вітер.', ['Bate vântul', 'Bate vânt']),
      task('Молния.', 'Блискавка.', ['Fulger', 'Fulgerul']),
      task('Гром.', 'Грім.', ['Tunet', 'Tunetul']),
    ],
  },
  {
    id: 'anotimpuri',
    kind: 'topic',
    theme: 'nature',
    ro: 'primăvara, vara, toamna, iarna',
    tr: bi('времена года', 'пори року'),
    meaning: bi(
      'Весна, лето, осень, зима. «Летом», «зимой» — это просто слово с артиклем, без предлога: vara, iarna.',
      'Весна, літо, осінь, зима. «Улітку», «узимку» — це просто слово з артиклем, без прийменника: vara, iarna.',
    ),
    examples: [
      w('Vara mergem la mare.', 'Летом мы ездим на море.', 'Улітку ми їздимо на море.'),
      w('Iarna e frig și ninge.', 'Зимой холодно и идёт снег.', 'Узимку холодно й іде сніг.'),
      w('Primăvara totul înflorește.', 'Весной всё цветёт.', 'Навесні все цвіте.'),
      w('Toamna plouă des.', 'Осенью часто идут дожди.', 'Восени часто йдуть дощі.'),
    ],
    expressions: [
      w('anotimp', 'время года', 'пора року'),
      w('primăvară', 'весна', 'весна'),
      w('toamnă', 'осень', 'осінь'),
      w('iarnă', 'зима', 'зима'),
    ],
    remember: bi(
      '«Летом» — **vara**, «зимой» — **iarna**: артикль сам делает из слова «когда». «Этим летом» — **vara asta**.',
      '«Улітку» — **vara**, «узимку» — **iarna**: артикль сам робить зі слова «коли». «Цього літа» — **vara asta**.',
    ),
    practice: [
      task('Летом.', 'Улітку.', ['Vara']),
      task('Зимой холодно.', 'Узимку холодно.', ['Iarna e frig', 'Iarna este frig']),
      task('Осенью часто идут дожди.', 'Восени часто йдуть дощі.', ['Toamna plouă des', 'Toamna plouă mult', 'Toamna plouă deseori']),
    ],
  },
  {
    id: 'padure',
    ...
    tr: bi('лес', 'ліс'),
    meaning: bi(
      'Лес. В Карпатах живёт много бурых медведей, поэтому в горах встречаются таблички «Atenție, urși!» — «Осторожно, медведи!».',
      'Ліс. У Карпатах живе багато бурих ведмедів, тому в горах трапляються таблички «Atenție, urși!» — «Обережно, ведмеді!».',
    ),
    examples: [
      w('Mergem în pădure după ciuperci.', 'Идём в лес за грибами.', 'Ідемо в ліс по гриби.'),
      w('Atenție, urși!', 'Осторожно, медведи!', 'Обережно, ведмеді!'),
      w('Nu hrăniți urșii!', 'Не кормите медведей!', 'Не годуйте ведмедів!'),
      w('În pădure e liniște.', 'В лесу тихо.', 'У лісі тихо.'),
    ],
    expressions: [
      w('ciuperci', 'грибы', 'гриби'),
      w('urs', 'медведь', 'ведмідь'),
      w('copac', 'дерево', 'дерево'),
      w('lup', 'волк', 'вовк'),
    ],
    remember: bi(
      'За чем идём — **după**: după ciuperci (за грибами), după apă (за водой). Медведь — **urs**, медведи — **urși**.',
      'По що йдемо — **după**: după ciuperci (по гриби), după apă (по воду). Ведмідь — **urs**, ведмеді — **urși**.',
    ),
    practice: [
      task('Идём в лес.', 'Ідемо в ліс.', ['Mergem în pădure']),
      task('Осторожно, медведи!', 'Обережно, ведмеді!', ['Atenție, urși', 'Atenție la urși']),
      task('Грибы.', 'Гриби.', ['Ciuperci', 'Ciupercile']),
    ],
  },
  {
    id: 'rau-lac',
    ...
    tr: bi('река', 'річка'),
    meaning: bi(
      'Река. Главная река — Dunărea, Дунай. Рядом — озеро, родник, берег и вопрос «можно ли здесь купаться?».',
      'Річка. Головна річка — Dunărea, Дунай. Поруч — озеро, джерело, берег і питання «чи можна тут купатися?».',
    ),
    examples: [
      w('Râul trece prin mijlocul orașului.', 'Река протекает через центр города.', 'Річка тече через центр міста.'),
      w('Se poate face baie în lac?', 'В озере можно купаться?', 'В озері можна купатися?'),
      w('Apa de izvor e foarte rece.', 'Родниковая вода очень холодная.', 'Джерельна вода дуже холодна.'),
      w('Stăm pe malul râului.', 'Сидим на берегу реки.', 'Сидимо на березі річки.'),
    ],
    expressions: [
      w('lac', 'озеро', 'озеро'),
      w('izvor', 'родник', 'джерело'),
      w('mal', 'берег', 'берег'),
      w('a face baie', 'купаться', 'купатися'),
    ],
    remember: bi(
      'Râu — **средний род**: râul, râuri. «Купаться» в реке или море — **a face baie** (дословно «делать ванну»).',
      'Râu — **середній рід**: râul, râuri. «Купатися» в річці чи морі — **a face baie** (дослівно «робити ванну»).',
    ),
    practice: [
      task('Здесь можно купаться?', 'Тут можна купатися?', ['Se poate face baie aici', 'Putem face baie aici']),
      task('Озеро.', 'Озеро.', ['Lac', 'Lacul']),
      task('На берегу реки.', 'На березі річки.', ['Pe malul râului']),
    ],
  },
  {
    id: 'animale',
    kind: 'topic',
    theme: 'nature',
    ro: 'câine, pisică, oaie',
    tr: bi('животные', 'тварини'),
    meaning: bi(
      'Домашние и деревенские животные. В румынских сёлах до сих пор много овец — пастушество здесь древняя традиция.',
      'Домашні й сільські тварини. У румунських селах досі багато овець — пастушество тут давня традиція.',
    ),
    examples: [
      w('Aveți animale de companie?', 'У вас есть домашние животные?', 'У вас є домашні тварини?'),
      w('Câinele meu se numește Rex.', 'Мою собаку зовут Рекс.', 'Мого собаку звати Рекс.'),
      w('La bunici avem o vacă și găini.', 'У бабушки с дедушкой есть корова и куры.', 'У бабусі й дідуся є корова й кури.'),
      w('Ciobanul are o turmă de oi.', 'У пастуха стадо овец.', 'У пастуха отара овець.'),
    ],
    expressions: [
      w('animale de companie', 'домашние питомцы', 'домашні улюбленці'),
      w('vacă', 'корова', 'корова'),
      w('oaie', 'овца', 'вівця'),
      w('cal', 'лошадь', 'кінь'),
      w('pasăre', 'птица', 'птах'),
    ],
    remember: bi(
      'Мн. число бывает неожиданным: oaie — **oi**, pasăre — **păsări**, cal — **cai**. «Меня зовут / его зовут» — **mă numesc / se numește**.',
      'Множина буває несподіваною: oaie — **oi**, pasăre — **păsări**, cal — **cai**. «Мене звати / його звати» — **mă numesc / se numește**.',
    ),
    practice: [
      task('У вас есть домашние животные?', 'У вас є домашні тварини?', ['Aveți animale de companie', 'Ai animale de companie']),
      task('Овцы.', 'Вівці.', ['Oi', 'Oile']),
      task('Мою собаку зовут Рекс.', 'Мого собаку звати Рекс.', ['Câinele meu se numește Rex', 'Câinele meu e Rex']),
    ],
  },
];
