...
const THEMES: CardTheme[] = ['work', 'docs', 'health', 'shop', 'transport', 'home', 'bank', 'food', 'social', 'travel', 'post', 'school', 'leisure', 'nature'];
const ICON: Record<CardKind | CardTheme, string> = { work: '💼', docs: '📄', health: '🩺', shop: '🛒', transport: '🚌', home: '🏠', bank: '🏦', food: '🍽', social: '👋', travel: '🧳', post: '📦', school: '🎒', leisure: '⚽', nature: '🌦', word: '📝', phrase: '💬', topic: '💡' };
