...
const THEMES: CardTheme[] = ['work', 'docs', 'health', 'shop', 'transport', 'home', 'bank', 'food', 'social'];
const ICON: Record<CardKind | CardTheme, string> = { work: '💼', docs: '📄', health: '🩺', shop: '🛒', transport: '🚌', home: '🏠', bank: '🏦', food: '🍽', social: '👋', word: '📝', phrase: '💬', topic: '💡' };
